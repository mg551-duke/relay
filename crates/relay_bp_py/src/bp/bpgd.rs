...
impl BPGDDecoderF64 {
    ...
    #[pyo3(signature = (
        ...
        fallback_explicit_c_damp_messages=None,
        fallback_c_damp_dist_interval=None,
        fallback_relay_posteriors=true,
    ...
    pub fn new(
        ...
        fallback_explicit_c_damp_messages: Option<&Bound<'_, PyArray2<f64>>>,
        fallback_c_damp_dist_interval: Option<(f64, f64)>,
        fallback_relay_posteriors: bool,
