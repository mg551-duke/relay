#!/usr/bin/env python3
"""Detailed cluster runner for damping-only BP heatmaps on gross-code memory-Z.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "examples/notebook_data/bicycle_bivariate_144_12_12_paper_damping_iteration_heatmap_cluster_Z_basis "
            "under the repo root."
        ),
    )
    parser.add_argument(
...
def main() -> None:
    ...
    save_stem = "bicycle_bivariate_144_12_12_paper_damping_iteration_heatmap_cluster_Z_basis"
    output_dir = (
